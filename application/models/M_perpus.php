...
class M_perpus extends CI_Model
{
  ...
  public function insert_detail($where)
	{
		$sql ="insert into detail_pinjam (id_pinjam,id_buku,denda) select orderan.id_pinjam,orderan.id_buku,orderan.denda from orderan where orderan.id_anggota='$where'";
		$this->db->query($sql);
	}
